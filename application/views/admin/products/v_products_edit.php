...
<table width="100%" cellspacing="5">
    <tr>
       ...
       <?=Form::label('cat', 'Категории')?>: <br/><br/><?=Form::select('cat', $cats, $getcat, array('multiple' => 'multiple', 'size' => 7, 'class' => 'sel', 'id' => 'cat'))?><br/><br/>
        <?=Form::label('cat', 'Под катeгории')?>: <br/><br/><?=Form::select('pod_cat', $pod_cats, $data['cat'], array('multiple' => 'multiple', 'size' => 7,  'class' => 'sel', 'onclick' =>'click', 'id'=>'pod_cat'))?><br/><br/>
        <?=Form::label('cost', 'Цена')?>: <br/><br/><?=Form::input('cost', $data['cost'], array('size' => 20))?> руб.<br/><br/>
        <?=Form::label('status', 'Статус')?>:<br/><br/><?=Form::checkbox('status', 1, (bool) $data['status'])?> Активен <br/> <br/>
         <?=Form::label('status', 'Популярность')?>:<br/><br/><?=Form::checkbox('popular', 1, (bool) $data['popular'])?> Активен
        </td>
    </tr>
