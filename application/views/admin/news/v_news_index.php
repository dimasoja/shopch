...
<table width="100%" border="0" class="tbl"  cellspacing="0">
    <thead>
        <tr height="30">
            <th>Дата</th><th>Название</th><th>Лента</th><th>Функции</th>
        </tr>
    </thead>
...
<td align="center" width="150">  <? if ($news->new_chek == 1):?> активен  <?endif?>  <? if ($news->new_chek == 0):?>не  активен  <?endif?>  <br/><br/> </td>
